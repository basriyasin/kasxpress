                    ...
                    <div class="row">
                        <div class="col-md-12 column">
                            <label class="f-13">
                                ...
                                Izinkan KasXpress untuk mengirimkan saya informasi melalui email
                            </label>
                        </div>
                        <div class="col-md-12 column">
                            <label class="f-13">
                                <input type="checkbox" name="documents.agree1" required>
                                Saya telah membaca dan saya setuju dengan <a target="_blank" href="{{route('front.login')}}">Kebijakan Privasi </a> &amp; <a target="_blank" href="{{route('front.login')}}">Syarat Ketentuan </a>
                            </label>
                        </div>
